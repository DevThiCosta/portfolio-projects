      ...
      {outOfStock ? (
        ...
        <>
          <div className="mt-2 flex items-center justify-between gap-2">
            <div className="flex items-center gap-1">
              <button
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full bg-neutral-900 text-lg transition-colors hover:bg-neutral-800 active:scale-95"
              >
                −
              </button>
              ...
              <button
                ...
                disabled={qty >= maxQty}
                className="flex h-11 w-11 items-center justify-center rounded-full bg-neutral-900 text-lg transition-colors hover:bg-neutral-800 active:scale-95 disabled:opacity-40"
              >
                +
              </button>
            </div>
            <Button size="lg" className="flex-1" disabled={pending} onClick={handleAdd}>
          ...
          <input
            ...
            className="mt-2 w-full rounded-md border border-neutral-800 bg-neutral-950 px-2 py-2 text-sm outline-none transition-colors focus:border-accent"
          />
        </>
      )}
